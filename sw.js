const CACHE='umi-no-chizu-puzzle-v2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data/theme.js','./data/geography.js','./manifest.json','./assets/japan-prefectures.svg','./assets/sea-hero.svg','./assets/icons/icon.svg'];
